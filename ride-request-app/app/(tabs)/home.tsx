...
export default function Home() {
  ...
  const handleSelectDestination = (item: any) => {
    setSelectedDestination({ latitude: parseFloat(item.lat), longitude: parseFloat(item.lon) });
    ...
    <View style={{ flex: 1 }}>
      {currentLocation && (
        ...
        >
          ...
          {selectedDestination && <Marker coordinate={selectedDestination} title="Destination" pinColor="blue" />}
        </MapView>
      )}
